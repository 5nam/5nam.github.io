...
6. 테스트
   ...
   ![결과 화면]({{site.url}}/images/2024-01-18-ttottoga(2)/Untitled.png)
...
- GeneralException 은 RuntimeException 상속 받음
  ...
  ![Untitled]({{site.url}}/images/2024-01-18-ttottoga(2)/Untitled 1.png)

  - 런타임에 발생한 Exception 으로써 MasterExceptionHandler 가 감지하게 됨

- 그 이유는 MasterExceptionHandler 가 `@RestControllerAdivce` 를 가지고 있기 때문

  ![Untitled]({{site.url}}/images/2024-01-18-ttottoga(2)/Untitled 2.png)
