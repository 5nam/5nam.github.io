...
![image01]({{site.url}}/images/2024-08-09-niornear_project(3)/image01.png)

### Public Access

- 퍼블릭 액세스 권한 → 모두에게 액세스 권한을 오픈 or 임의의 사용자에게 접근 권한 제한할 것인지 설정하는 것
  
    ![image02]({{site.url}}/images/2024-08-09-niornear_project(3)/image02.png)
...
![image03]({{site.url}}/images/2024-08-09-niornear_project(3)/image03.png)
...
![image04]({{site.url}}/images/2024-08-09-niornear_project(3)/image04.png)
